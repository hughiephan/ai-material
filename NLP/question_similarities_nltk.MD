...
For the questions below, question 1 mentions a particular place `India` while question 2 ask a more general question, so we want to mark these as different. 
