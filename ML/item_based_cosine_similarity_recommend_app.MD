...
Populate the `grouped_items` and `all_items` from the previous step into the following code and create the new file `app.py`
...
grouped_items = <----Replace me
all_items = <-----Replace me
