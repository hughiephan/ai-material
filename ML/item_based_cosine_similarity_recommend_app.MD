...
![image](https://github.com/hughiephan/DPL/assets/16631121/965764d5-dead-49d1-a300-d65e1e4b95e4)
...
Add the `group_items` and `all_items` from the previous step
