...
Our basic model is made up of Convolutional Layers and Pooling Layers, with a fully-connected layer at the end. `Conv2D(32, (3, 3)` means that this layer can process 
