...
# train = data[data['image'].isin(train_images)][:1000]
# test = data[data['image'].isin(val_images)][:100]
...
![image](https://github.com/hughiephan/DPL/assets/16631121/fb48fa44-d1b9-49d7-8896-72610c6fec00)
